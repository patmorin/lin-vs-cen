...
\begin{proof}
  ...
  Let $Q':=\{\mu_1\in Q: \mu\in \VE(G_{2r}(\mu_1))\}$.  For any $\mu_1\in Q'$,
  ...
  \[  3(5r+1)^2 \ge |\VE(G_{5r/2}(\mu))| \ge \sum_{\mu_1\in Q'} |\VE(G_{r/2}(\mu_1))|
  = 3|Q'|(r-2)^2 \enspace .
  \]
