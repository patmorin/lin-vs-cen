...
Pat~Morin especially enjoyed early-morning discussions with Stefan~Langerman on the Seabourne Terrace and to Omer Angel for pointing out that the problem on $k\times k$ grid has a simple solution.
