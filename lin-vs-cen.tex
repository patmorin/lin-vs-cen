...
To prove \cref{kun_obrien_general}, \citet{kun.obrien.ea:polynomial} establish the critical role that lower bounds on the linear linear chromatic number of pseudogrids and subcubic trees play in establishing an upper bound on $\chicen(G)$ as a function of $\chilin(G)$. In their work, they establish (asymptotically) tight lower bounds for the linear chromatic number of subcubic trees, but their lower bounds for pseudogrids are not tight.
