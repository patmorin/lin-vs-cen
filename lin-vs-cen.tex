...
To put our results into context, we summarize the proof of \cref{kun_obrien_general}:
...
In the current work, we spend considerable effort to improve the technical lemma in Point~3 and prove the following:
